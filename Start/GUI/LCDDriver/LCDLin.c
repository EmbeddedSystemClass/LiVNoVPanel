...
*/
  ...
  #elif LCD_DISPLAY_INDEX == 2     /* 3. display in a multi-display configuration */
    #define LCD_INIT_CONTROLLER()     LCD_INIT_CONTROLLER_2()
  #elif LCD_DISPLAY_INDEX == 3     /* 4. display in a multi-display configuration */
    #define LCD_INIT_CONTROLLER()     LCD_INIT_CONTROLLER_3()
  #elif LCD_DISPLAY_INDEX == 4     /* 5. display in a multi-display configuration */
    #define LCD_INIT_CONTROLLER()     LCD_INIT_CONTROLLER_4()
  #else
    #error Not supported yet!
  #endif
#endif
...
*/
  ...
  #error Non-optimized mode. Please select an other mode, define LCD_ALLOW_NON_OPTIMIZED_MODE in LCDCOnf.h or contact info@segger.com.
#endif
