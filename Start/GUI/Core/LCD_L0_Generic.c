...
#elif (FIXEDPALETTE == 666) && (LCD_SWAP_RB == 0)
...
#elif (FIXEDPALETTE == 666) && (LCD_SWAP_RB == 1)
  #define COLOR2INDEX(Color) LCD_Color2Index_M666(Color)
  #define INDEX2COLOR(Index) LCD_Index2Color_M666(Index)
  #define GETINDEXMASK()     LCD_GetIndexMask_M666()
#elif (FIXEDPALETTE == 888) && (LCD_SWAP_RB == 0)
...
#elif (FIXEDPALETTE == 888) && (LCD_SWAP_RB == 1)
